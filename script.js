/* ============================================================
   Мини-лендинг «Запуск речи» — логика
   - подстановка ссылок мессенджеров (те же боты ЛисицыУМ, тег zapusk)
...
(function () {
  ...
  //  zapusk.лисицыум.рф, вписать сюда id и раскомментировать блок в index.html.
